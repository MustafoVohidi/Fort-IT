                    ...
                    <div class="header-left">
                        ...
                        <div class="dropdown for-message">
                            ...
                            <div class="dropdown-menu" aria-labelledby="message">
                                <p class="red">У Вас 4 сообщение</p>
                                <a class="dropdown-item media bg-flat-color-1" href="#">
                                ...
                                <a class="dropdown-item media bg-flat-color-3" href="#">
                                    ...
                                    <span class="message media-body">
                                        <span class="name float-left">Вохиди Мустафо</span>
                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        ...
                        <div class="user-menu dropdown-menu">
                            ...
                            <a class="nav-link" href="#"><i class="fa fa-user"></i> Уведомления <span class="count">13</span></a>

                            <a class="nav-link" href="#"><i class="fa fa-cog"></i> Настройки</a>

                            <a class="nav-link" href="#"><i class="fa fa-power-off"></i> Выйты</a>
                        </div>
                    </div>
